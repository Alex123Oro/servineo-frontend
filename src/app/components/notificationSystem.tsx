...
export default function NotificationSystem({ userId }: NotificationSystemProps) {
    ...
    if (isOnline) {
      pollingIntervalRef.current = setInterval(() => {
        if (isOpen) {
          ...
          // Si el panel está cerrado, solo actualizar el contador según el filtro activo
          fetchUnreadCount(filter);
        }
      }, POLLING_INTERVAL);
  ...
  }, [isOpen, isOnline, filter, fetchNotifications, fetchUnreadCount]);
  ...
  const handleNotificationClick = (notification: INotification) => {
    ...
    if (notification.appointment_id) {
      router.push(`/calendario?appointment=${notification.appointment_id}`);
      setIsOpen(false);
      return;
    }
    ...
    <div className="relative">
      ...
      {isOpen && (
        ...
        >
          <div
            ref={modalRef}
            className="bg-white rounded-lg shadow-xl w-[90vw] sm:w-96 max-w-md max-h-[80vh] flex flex-col pointer-events-auto border border-gray-200"
          >
            ...
            <div className="p-4 border-b border-gray-200 bg-white">
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 rounded-md border border-gray-300 bg-white text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none cursor-pointer"
              ...
              {notifications.map((notification) => {
                ...
                return (
                  <div
                    ...
                    className={`p-4 border-b border-gray-100 cursor-pointer transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                      isRead
