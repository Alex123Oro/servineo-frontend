...
interface FooterProps {
  onRestartTour?: () => void; // Función opcional para reiniciar el tour
}
...
export default function Footer({ onRestartTour }: FooterProps) {
  ...
  const exploreLinks = [
    ...
    // Agregamos Tour como enlace "simulado"
    ...(onRestartTour ? [{ name: 'Hacer Tour', path: '#' }] : []),
  ];  

  const handleTourClick = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    e.preventDefault();
    onRestartTour?.();
  };
    ...
    <footer className="bg-[#0D1B3E] text-white font-['Roboto']" role="contentinfo" aria-label="Pie de página de Servineo">
      <div className="max-w-7xl mx-auto px-6 py-16 space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-base" role="navigation" aria-label="Enlaces del pie de página">
          ...
          {/* Exploremos SERVINEO */}
          <div>
            <h3 className="text-xl font-semibold text-[var(--secondary)] mb-2">Exploremos SERVINEO</h3>
            <ul className="space-y-3 mt-2">
              {exploreLinks.map((link, i) => (
                <li key={i}>
                  {link.name === 'Hacer Tour' ? (
                    <a
                      href="#"
                    ...
                    <Link href={link.path} className={styles.footerLink}>{link.name}</Link>
                  )}
                </li>
              ))}
            </ul>
          ...
          <div aria-labelledby="contacto-heading">
            ...
            <div className="space-y-4 mt-2 text-white">
              <div className="flex items-center">
                ...
                <a href="https://maps.app.goo.gl/n7LWKTiuy92PBoAx8?g_st=aw" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--secondary)] transition-colors">
                  Cochabamba, Bolivia
                </a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="https://wa.me/59163765632" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--secondary)] transition-colors">
                  +591 637-65632
                </a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:espinozapacaflora@gmail.com?subject=Consulta de servicios" className="hover:text-[var(--secondary)] transition-colors">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 border-t border-gray-700 pt-6">
          <div className="flex items-center justify-center sm:justify-start gap-4">
            <h3 className="text-xl font-semibold text-[var(--secondary)]">Síguenos</h3>
            <div className="flex flex-row gap-6">
              <a href="https://facebook.com/DptoInformaticaSistemas/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1AA7ED]">
                <Facebook className="h-6 w-6" />
              </a>
              <a href="https://instagram.com/dpto_informatica.sistemas.umss/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1AA7ED]">
                <Instagram className="h-6 w-6" />
              </a>
              <a href="https://x.com/umssboloficial?lang=es" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1AA7ED]">
          ...
          <div className="flex items-center justify-center sm:justify-end gap-2">
            ...
            <select className="bg-[#0D1B3E] text-white border border-gray-600 rounded px-2 py-1 focus:outline-none focus:border-[var(--secondary)]" defaultValue="es">
