    ...
    <main>
      ...
      >
        ...
        <div id="passwordSection">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button
              ...
              onClick={() => (window as any).togglePasswordChange?.()}
            >
              Cambiar contraseña
            </button>
          </div>
        ...
        <div
          ...
          style={{ display: 'none', flexDirection: 'column', gap: '12px', marginTop: '10px' }}
        >
          ...
          <div style={{ position: 'relative' }}>
            ...
            <button
              ...
              onClick={(e) =>
                (window as any).togglePasswordVisibility?.('currentPassword', e.target)
              }
            >
              👁
            </button>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <button
              ...
              onClick={(e) => (window as any).togglePasswordVisibility?.('newPassword', e.target)}
            >
              👁
            </button>
          </div>
          ...
          <div style={{ display: 'flex', gap: '8px', marginTop: '10px' }}>
            <button
              type="button"
              className="btn"
              onClick={() => (window as any).savePasswordChange?.()}
            >
            ...
            <button
              ...
              onClick={() => (window as any).cancelPasswordChange?.()}
            >
              Cancelar
            </button>
          </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '15px' }}>
          <button type="button" className="btn" onClick={() => (window as any).saveProfile?.()}>
            Guardar
          </button>
          <button
            type="button"
            className="btn"
            style={{ background: '#ccc', color: '#000' }}
            onClick={() => (window as any).closeEdit?.()}
          >
            Cancelar
          </button>
        </div>
      ...
      <div id="profileModal" className="modal" aria-hidden="true">
        ...
        <button className="btn" onClick={() => (window as any).closeProfileModal?.()}>
          Cerrar
        </button>
      </div>
    </main>
