    ...
    try {
      ...
      if (res.success && res.data) {
        ...
        try {
          ...
          const initialMerged = {
            ...datos.user,
            name: prev?.name ?? datos.user.name,
            email: prev?.email ?? datos.user.email,
            picture: prev?.picture ?? datos.user.picture,
            photo: prev?.photo,
        ...
        // Fetch perfil completo y sincronizar nombre/correo/foto con localStorage
        try {
          ...
          console.debug("No se pudo obtener perfil completo (foto), continuando con datos básicos", profileErr);
        }
